...
# ===== CONFIGURAÇÃO FIXA =====
DATA_BASE = date(2025, 12, 30)  # 30/12/2025 = A/B
PERIODICIDADE = 3  # dias por grupo
...
def grupo_por_data(d):
    ...
    pos = delta % (PERIODICIDADE * 2)  # ciclo de 6 dias
    return "A/B" if pos < PERIODICIDADE else "C/D"
